    ...
    register(form.values.email, form.values.password, form.values.name)
      .then(() => {
        ...
        notifications.show({
          ...
          message:
            'Вы успешно зарегистрировались. Подтвердите свой аккаунт по ссылке в письме.',
          autoClose: 10000,
        });
      })
      .catch(() => {
        notifications.show({
          ...
          message:
            'Произошла ошибка при регистрации или пользователь с таким email уже существует',
          autoClose: 10000,
        });
      });
  };
