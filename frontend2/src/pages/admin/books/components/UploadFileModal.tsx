...
import { BookCreateResponse, JSONFile } from '../Book';
...
function UploadFileModal(props: UploadFileModalProps) {
  ...
  const { dropZoneOpened, setDropZoneOpened, onBookUpload } = props;
        ...
        >
          <div style={{ pointerEvents: 'none' }}>
            ...
            <Text ta="center" size="sm" mt="xs" color="dimmed">
              Drag&apos;n&apos;Drop Только файлы с расширением{' '}
              <i>.json, .txt, .csv</i> и размером не более <i>30 МБ</i> могут
              быть загружены.
            </Text>
          </div>
        </Dropzone>
