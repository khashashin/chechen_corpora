...
function SearchWordPopularityChart(props: ChartDataTypes) {
	...
	return (
		<>
			<h4>
				График популярности найденных уникальных слов в текстах по годам (всего найдено{' '}
				{chartDataArray.reduce((acc: number, item: any) => acc + item.words, 0)} результатов по
				вашему запросу):
			</h4>
